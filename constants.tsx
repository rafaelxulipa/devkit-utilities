...
const BinaryIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 3v18M15 3v18M4 8h4m-4 8h4m8-8h4m-4 8h4" />
    </svg>
);
...
export const ALL_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Estime as verbas rescisórias: saldo de salário, aviso prévio, 13º e férias proporcionais, e multa do FGTS.',
    path: 'calculadora-rescisao-clt',
    category: Category.DOCUMENTS,
    icon: BriefcaseIcon,
  ...
  },
  {
    ...
    description: 'Embeleze e formate JSON, JavaScript, TypeScript, HTML, CSS/SCSS/LESS, Markdown, YAML, GraphQL, XML, PHP e SQL.',
    path: 'formatador-codigo',
    category: Category.DEV,
    icon: CodeFormatterIcon,
    component: CodeFormatter,
    tags: ['json', 'javascript', 'typescript', 'html', 'css', 'scss', 'less', 'markdown', 'yaml', 'graphql', 'xml', 'php', 'sql', 'formatar', 'beautify', 'indentar', 'viewer', 'dev'],
  },
  {
    id: 'uuid-generator',
  ...
  },
  {
   ...
   {
    id: 'encoding-hash-tool',
    title: 'Base64 e Gerador de Hash',
    description: 'Codifique/decodifique Base64 e gere hashes MD5, SHA-1, SHA-256, SHA-384 e SHA-512.',
    path: 'base64-hash',
    category: Category.DEV,
    icon: BinaryIcon,
