...
import { generateCreditCard, generateBankAccount } from '../utils/documentGenerators';
...
const FinancialGenerator: React.FC = () => {
        ...
        <div className="space-y-6 max-w-lg mx-auto">
            {data && (
                <div className="space-y-3 border border-light-secondary/20 dark:border-dark-secondary/20 rounded-lg p-4">
                    <DataRow label="Cartão de Crédito" value={data.creditCard} />
                    <DataRow label="Conta Bancária" value={data.bankAccount} />
                </div>
            )}
